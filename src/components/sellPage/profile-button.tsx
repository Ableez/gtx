  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <div className="bg-neutral-200 dark:bg-neutral-900 aspect-square w-10 h-10 text-center font-medium text-opacity-20 dark:text-white leading-none uppercase">
          {user ? (
