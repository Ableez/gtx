...
const AdminCardMessages = ({
  ...
  return (
    <div
      key={idx}
      className={`my-3 relative md:max-w-[350px] max-w-[260px] min-w-[200px] transition-all duration-500 flex align-middle place-items-end rounded-b-2xl justify-between gap-2 bg-neutral-200/50 dark:bg-black shadow-s ${
