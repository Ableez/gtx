...
const ServiceDetail = (props: Props) => {
  return (
    <div>
      <section className="bg-pink-100 text-left dark:bg-neutral-900 py-24 px-4 md:px-16">
      ...
      <section className="bg-white text-left dark:bg-neutral-800 py-24 px-4 md:px-16">
        <div className="grid max-w-screen-lg mx-auto md:gap-8 md:grid-cols-12 gap-12">
