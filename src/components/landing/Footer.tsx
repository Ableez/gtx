      ...
      <footer className="bg-neutral-100 md:p-6 dark:bg-neutral-900 py-16 border-t">
        <div className="max-w-screen-lg mx-auto">
          <div className="mx-auto max-w-screen-xl">
            ...
            <div className="sm:flex sm:items-center sm:justify-between text-center mx-auto">
              ...
              <div className="flex mt-4 px-4 md:px-0 space-x-6 justify-center sm:mt-0 py-2">
                <a
                  href="#"
