      ...
      <>
        <div className="container font-bold text-lg relative max-w-screen-sm">
          ...
          <div className="my-6">
            ...
            >
              <SelectTrigger className="w-full ring-neutral-300 focus-visible:ring-neutral-400 relative disabled:bg-opacity-50">
                <SelectValue
          ...
          <div>
            ...
            <div
              className={`flex align-middle place-items-center justify-between ring-neutral-400 gap-2 ring-1 rounded-xl px-3 ${
                !logged && "dark:ring-neutral-700 ring-neutral-300"
              }`}
            >
          ...
          <div className="mt-10">
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogCancel className="absolute top-2 right-4 bg-neutral-200 rounded-full p-1">
                  <XMarkIcon width={20} />
                </AlertDialogCancel>
                ...
                <div className="grid grid-flow-col gap-6">
                  ...
                  <AlertDialogAction
                    ...
                    className="bg-primary shadow-none py-4 rounded-xl disabled:bg-opacity-50"
                  >
                    Live Chat
                  </AlertDialogAction>
                </div>
