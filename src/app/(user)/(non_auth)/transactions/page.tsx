...
const TransactionCard = (
  ...
  return (
    <Link
      ...
      key={idx}
      className="grid grid-flow-col grid-cols-7 align-middle py-4 px-4 hover:px-5 hover:bg-neutral-50 duration-100 ease-in cursor-pointer h-fit place-items-center"
    >
...
const Transactions = (props: Props) => {
  ...
  return (
    <div className="duration-300 overflow-hidden">
      <div className="md:h-[24vh]">
        <SellNavbar />
        <nav className=" container px-4 py-3 flex align-middle justify-between place-items-center">
      ...
      <div className="bg-white flex-col divide-y divide-neutral-100 pb-4 h-[76vh] overflow-y-scroll">
        {loading ? (
          <Loading />
        ) : (
          <>
